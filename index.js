      ...
      client.messages
        .create({
          body:
            ...
            "! This is a reminder for your Glamour Avenue appointment tomorrow, " +
      ...
      client.messages
        .create({
          body:
            ...
            appointment.client.firstName[0].toUpperCase() +
            appointment.client.firstName.slice(1).toLowerCase() +
            "! We look forward to seeing you at your Glamour Avenue appointment today at " +
            appointment.startTime +
            ". " +
...
app.get("/", (req, res) => {
  res.send("The Glamour Avenue server is up and running!");
});
