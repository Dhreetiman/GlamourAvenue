...
const addAppointmentMutation = {
  ...
  async resolve(parent, args, context) {
    ...
    const createEventObject = (appointment) => {
      const eventObject = {
        title: "Glamour Avenue Appointment",
      ...
      client.messages
        .create({
          body:
            ...
            "! Your Glamour Avenue appointment has been scheduled for " +
            ...
            ` at 1506 Broadway, Hewlett, NY 11557. Reply Y to confirm.\n\nIf you need to cancel or reschedule your appointment, please call us at (516) 442-8122 or visit ${
              process.env.NODE_ENV === "production"
                ? "https://is.gd/glamour_avenue"
                : "https://is.gd/glamouravenue"
            }. We look forward to seeing you soon!`,
          from: process.env.GLAMOUR_AVENUE_TEXT_NUMBER,
          to:
            process.env.NODE_ENV === "production"
              ? clientPhoneNumber[0]
    ...
    let transporter = nodemailer.createTransport({
      ...
      secure: false,
      auth: {
        user: process.env.GLAMOUR_AVENUE_EMAIL,
        pass: process.env.GLAMOUR_AVENUE_EMAIL_APP_PASSWORD,
      },
      debug: false,
      logger: true,
    });
        ...
        mjmlUtils
          ...
          .then(async (finalTemplate) => {
            await transporter.sendMail({
              from: process.env.GLAMOUR_AVENUE_EMAIL,
              to: client_res.email,
              subject: "Your Glamour Avenue Appointment",
              html: finalTemplate,
            });
          });
